...
function specDisplay() {
    if (window.counter === 1) {
        ...
        document.getElementById("spec_button1").style.borderRight = "5px solid teal";
        document.getElementById("spec_button1").style.borderBottom = "2px solid gold";
        document.getElementById("spec_button1").style.backgroundColor = "rgb(255,255,255,0.8)"

        document.getElementById("spec_button2").style.color = "white";
        document.getElementById("spec_button2").style.borderTop = "1px solid white;";
        document.getElementById("spec_button2").style.borderLeft = "5px solid gold;";
        document.getElementById("spec_button2").style.borderRight = "5px solid gold;";
        document.getElementById("spec_button2").style.borderBottom = "1px solid white";
        document.getElementById("spec_button2").style.backgroundColor = "rgb(0, 0, 0, 0.7)"
        ...
        document.getElementById("spec_button1").style.borderRight = "5px solid gold";
        document.getElementById("spec_button1").style.borderBottom = "2px solid white";
        document.getElementById("spec_button1").style.backgroundColor = "rgb(0, 0, 0, 0.7)"
        ...
        document.getElementById("spec_button2").style.borderRight = "5px solid teal";
        document.getElementById("spec_button2").style.borderBottom = "2px solid gold";
        document.getElementById("spec_button2").style.backgroundColor = "rgb(255,255,255,0.8)"
